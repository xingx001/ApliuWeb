...
namespace ApliuWeb
{
    ...
    public class ServerHub : Hub
    {
        ...
        /// <summary>
        /// 测试方法 方法名区分大小写（如未设定，则驼峰命名格式，客户端js里面首字母小写）
        /// </summary>
        /// <param name="message"></param>
        [HubMethodName("sendmsg")]
        public void SendMsg(string message)
        {
            //调用所有客户端的sendMessage方法 客户端js里面的方法，不区分大小写
        ...
        /// <param name="message"></param>
        /// <returns></returns>
        public async Task NewContosoChatMessageAsync(string name, string message)
        {
            await Clients.Others.addContosoChatMessageToPage(name);
