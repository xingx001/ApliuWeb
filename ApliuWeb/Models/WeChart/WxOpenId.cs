...
namespace ApliuWeb.WeChart
{
    public class WxOpenId
    {
        ...
        private static string openIdUri
        {
            get
            {
                return "https://api.weixin.qq.com/sns/oauth2/access_token?appid=" + WeChartBase.WxAppId + "&secret=" + WeChartBase.WxAppSecret + "&code={0}&grant_type=authorization_code";
            }
        }
        ...
        public static string GetOpenId(string code)
        {
            ...
            String content = WeChartBase.WxEncoding.GetString(responseData);
            try
            {
